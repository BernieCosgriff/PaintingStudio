...
class ColorChooserLandscape: UIControl {
    ...
    public init(frame: CGRect, color: UIColor){
        ...
        rSlider_ = UISlider(frame: CGRect(x: 5, y: 10, width: bounds.size.width - 10, height: 10))
        ...
        gSlider_ = UISlider(frame: CGRect(x: 5, y: (heightThird * 2) - 50, width: bounds.size.width - 10, height: 10))
        ...
        bSlider_ = UISlider(frame: CGRect(x: 5, y: (heightThird * 3) - 30, width: bounds.size.width - 10, height: 10))
